...
func (x *SubscribeBeaconsResponse) GetBeacon() *BeaconResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Beacon); ok {
			return x.Beacon
		}
	}
	return nil
...
func (x *SubscribeBeaconsResponse) GetColor() *BeaconColorResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Color); ok {
			return x.Color
		}
	}
	return nil
...
func (x *SubscribeBeaconsResponse) GetNote() *BeaconNoteResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Note); ok {
			return x.Note
		}
	}
	return nil
...
func (x *SubscribeBeaconsResponse) GetLast() *BeaconLastResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Last); ok {
			return x.Last
		}
	}
	return nil
...
func (x *SubscribeBeaconsResponse) GetSleep() *BeaconSleepResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Sleep); ok {
			return x.Sleep
		}
	}
	return nil
...
func (x *SubscribeBeaconsResponse) GetBeacons() *BeaconsResponse {
	if x != nil {
		if x, ok := x.Response.(*SubscribeBeaconsResponse_Beacons); ok {
			return x.Beacons
		}
	}
	return nil
...
func (x *NewGroupRequest) GetGroup() *NewTaskGroupRequest {
	if x != nil {
		if x, ok := x.Type.(*NewGroupRequest_Group); ok {
			return x.Group
		}
	}
	return nil
...
func (x *NewGroupRequest) GetMessage() *NewTaskMessageRequest {
	if x != nil {
		if x, ok := x.Type.(*NewGroupRequest_Message); ok {
			return x.Message
		}
	}
	return nil
...
func (x *NewGroupRequest) GetTask() *NewTaskRequest {
	if x != nil {
		if x, ok := x.Type.(*NewGroupRequest_Task); ok {
			return x.Task
		}
	}
	return nil
...
func (x *NewTaskRequest) GetSleep() *v1.CapSleep {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Sleep); ok {
			return x.Sleep
		}
	}
	return nil
...
func (x *NewTaskRequest) GetLs() *v1.CapLs {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Ls); ok {
			return x.Ls
		}
	}
	return nil
...
func (x *NewTaskRequest) GetPwd() *v1.CapPwd {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Pwd); ok {
			return x.Pwd
		}
	}
	return nil
...
func (x *NewTaskRequest) GetCd() *v1.CapCd {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Cd); ok {
			return x.Cd
		}
	}
	return nil
...
func (x *NewTaskRequest) GetWhoami() *v1.CapWhoami {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Whoami); ok {
			return x.Whoami
		}
	}
	return nil
...
func (x *NewTaskRequest) GetPs() *v1.CapPs {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Ps); ok {
			return x.Ps
		}
	}
	return nil
...
func (x *NewTaskRequest) GetCat() *v1.CapCat {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Cat); ok {
			return x.Cat
		}
	}
	return nil
...
func (x *NewTaskRequest) GetExec() *v1.CapExec {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Exec); ok {
			return x.Exec
		}
	}
	return nil
...
func (x *NewTaskRequest) GetCp() *v1.CapCp {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Cp); ok {
			return x.Cp
		}
	}
	return nil
...
func (x *NewTaskRequest) GetJobs() *v1.CapJobs {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Jobs); ok {
			return x.Jobs
		}
	}
	return nil
...
func (x *NewTaskRequest) GetJobkill() *v1.CapJobkill {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Jobkill); ok {
			return x.Jobkill
		}
	}
	return nil
...
func (x *NewTaskRequest) GetKill() *v1.CapKill {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Kill); ok {
			return x.Kill
		}
	}
	return nil
...
func (x *NewTaskRequest) GetMv() *v1.CapMv {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Mv); ok {
			return x.Mv
		}
	}
	return nil
...
func (x *NewTaskRequest) GetMkdir() *v1.CapMkdir {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Mkdir); ok {
			return x.Mkdir
		}
	}
	return nil
...
func (x *NewTaskRequest) GetRm() *v1.CapRm {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Rm); ok {
			return x.Rm
		}
	}
	return nil
...
func (x *NewTaskRequest) GetExecAssembly() *v1.CapExecAssembly {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_ExecAssembly); ok {
...
func (x *NewTaskRequest) GetShellcodeInjection() *v1.CapShellcodeInjection {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_ShellcodeInjection); ok {
...
func (x *NewTaskRequest) GetDownload() *v1.CapDownload {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Download); ok {
			return x.Download
		}
	}
	return nil
...
func (x *NewTaskRequest) GetUpload() *v1.CapUpload {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Upload); ok {
			return x.Upload
		}
	}
	return nil
...
func (x *NewTaskRequest) GetPause() *v1.CapPause {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Pause); ok {
			return x.Pause
		}
	}
	return nil
...
func (x *NewTaskRequest) GetDestruct() *v1.CapDestruct {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Destruct); ok {
			return x.Destruct
		}
	}
	return nil
...
func (x *NewTaskRequest) GetExecDetach() *v1.CapExecDetach {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_ExecDetach); ok {
			return x.ExecDetach
		}
	}
	return nil
...
func (x *NewTaskRequest) GetShell() *v1.CapShell {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Shell); ok {
			return x.Shell
		}
	}
	return nil
...
func (x *NewTaskRequest) GetPpid() *v1.CapPpid {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Ppid); ok {
			return x.Ppid
		}
	}
	return nil
...
func (x *NewTaskRequest) GetExit() *v1.CapExit {
	if x != nil {
		if x, ok := x.Args.(*NewTaskRequest_Exit); ok {
			return x.Exit
		}
	}
	return nil
...
func (x *SubscribeTasksResponse) GetGroup() *TasksGroupResponse {
	if x != nil {
		if x, ok := x.Type.(*SubscribeTasksResponse_Group); ok {
			return x.Group
		}
	}
	return nil
